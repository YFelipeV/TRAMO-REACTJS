          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-blue-head head-title shadow-primary border-radius-lg">
                <h4 className="text-light d-flex align-items-center"><img className='imagen-titulo' src={img_pen} alt="" style={{width:"24px",height:"24px", opacity:"90%"}} /> Solicitudes Pendientes</h4>
              </div>
            </div>
